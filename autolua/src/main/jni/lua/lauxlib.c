...
#define LEVELS1	10	/* stringSize of the first part of the stack */
#define LEVELS2	11	/* stringSize of the second part of the stack */
...
LUALIB_API char *luaL_prepbuffsize (luaL_Buffer *B, size_t sz) {
  ...
  if (B->size - B->n < sz) {  /* not enough space? */
    char *newbuff;
    size_t newsize = B->size * 2;  /* double buffer stringSize */
